	...
	public void acheterProduit(String nomAcheteur) {
		...
		if (!controlAcheterProduit.isAcheteurHabitant(nomAcheteur)) {
			...
			if (nomVendeur.length == 0) {
				...
				vente.append(nomAcheteur + " se déplace jusqu'à l'étal du vendeur " + nomVendeur[indexVendeur]
				...
				if (achat == 0) {
					...
					fin.append(nomAcheteur + " achète " + achat + " " + produit + " à " + nomVendeur[indexVendeur] + ".");
				}
